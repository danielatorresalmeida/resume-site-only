...
const translations = {
    ...
    skillGroups: [
      {
        ...
        text: "Python (FastAPI, boto3) · JavaScript (ES6+, TypeScript) · PHP · HTML5 · CSS3 · WordPress",
      },
      {
        title: "QA & Testing",
        text: "Functional & Non-functional · Unit, Integration, System, Acceptance · Test Case Design · Bug Reporting",
      },
      {
        title: "Cloud & DevOps",
        text: "AWS (Lambda, S3, API Gateway, IAM, CloudWatch) · Docker · Git/GitHub · CI/CD (GitHub Actions)",
      },
      {
        title: "Tools & Frameworks",
        text: "Postman · Pytest · Microsoft Word & Excel",
      },
      {
        title: "Languages",
        text: "Portuguese (Native) · English (Fluent)",
      },
    ],
  ...
  [LANG_PT]: {
    ...
    skillGroups: [
      ...
      {
        title: "QA e Testes",
        text: "Funcionais e Não Funcionais · Unit, Integration, System e Acceptance Testing · Conceção de Casos de Teste · Reporte de Bugs",
      },
      {
      ...
      },
      {
        ...
        text: "Postman · Pytest · Microsoft Word e Excel",
      },
      {
        title: "Idiomas",
        text: "Português (Nativo) · Inglês (Fluente)",
      },
    ],
